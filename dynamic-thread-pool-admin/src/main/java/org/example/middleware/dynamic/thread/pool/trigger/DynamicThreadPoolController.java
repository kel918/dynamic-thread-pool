package org.example.middleware.dynamic.thread.pool.trigger;

import org.example.middleware.dynamic.thread.pool.sdk.domain.model.entity.ThreadPoolConfigEntity;
import org.example.middleware.dynamic.thread.pool.types.Response;
...
public class DynamicThreadPoolController {
    ...
    /**
     * 查询线程池配置
     * curl --request GET \--url 'http://localhost:8089/api/v1/dynamic/thread/pool/query_thread_pool_config?appName=dynamic-thread-pool-test-app&threadPoolName=threadPoolExecutor'
     */
